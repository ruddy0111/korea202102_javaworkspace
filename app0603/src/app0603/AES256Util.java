...
public class AES256Util {
	...
	private static String key = "HYOJUHYOJUHYOJUHYOJU"; // 16자리 이상으로 key값을 부여하자
...
return new String(c.doFinal(byteStr),"UTF-8");
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("암호화 결과 : "+obj.encodeData(key)); 
			System.out.println("복호화 결과 : "+obj.decodeData(obj.encodeData(key)));

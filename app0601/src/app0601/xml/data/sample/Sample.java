...
public class Sample {
	//throws : 개발자가 해당 예외를 처리하지 않고, 메서드 호출자에게 전가시킨다.
	//아래  코드에서 main메서드를 호출한 자는 jvm이므로, 예외 발생 시 jvm에 의해 예외처리 결과가 출력
public static void main(String[] args) throws IOException{
	String key = "kLCh5gZmDraWwCj1wbhQXWijOKB7uPAf5I%2FBzfZKm8zTqbFGMhggCpGn4LFQH2Gk%2B2Hf3ZFwCwPtIk499FgdlA%3D%3D";
